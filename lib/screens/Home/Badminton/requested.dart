...
class BadmintonRequested extends StatelessWidget {
  const BadmintonRequested({Key? key}) : super(key: key);
...
class BTReturn extends StatefulWidget {
  final String name, noOfRacket,noOfCock;
  ...
  @override
  _BTReturnState createState() => _BTReturnState();
}

class _BTReturnState extends State<BTReturn> {
                                  ...
                                  builder: (context) {
                                    return PopUpRequest(
                                      onTap: () async {
                                        ...
                                        widget.uid==UserDetails.uid?Navigator
