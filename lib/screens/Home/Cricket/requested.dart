...
class RequestedCricket extends StatelessWidget {
  const RequestedCricket({Key? key}) : super(key: key);
...
class CRWidget extends StatefulWidget {
  final String name, ball,bat,gloves,helmet,innerPad,pad;
  ...
  @override
  _CRWidgetState createState() => _CRWidgetState();
}
